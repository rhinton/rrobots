...
want more precision you have to turn your radar slower.  Finally, to be 
precise, firing happens first, then turning, then moving, then scanning.
...
To start a match call:
  ...
  Usage: rrobots [options] file1 file2 ...
          ...
          --framerate N                Run the GUI at N frames per second
